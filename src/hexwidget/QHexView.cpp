...
QHexView::QHexView(QWidget * parent) : QAbstractScrollArea(parent),
        ...
        m_ShowAddress(true), m_ShowComments(true), m_io(0), m_Origin(0), m_AddressOffset(0),
	...
	setFont(QFont(QString::fromLocal8Bit("Monospace"), 8));
}
...
void QHexView::mnuCopy() {
	if(hasSelectedText()) {
		QApplication::clipboard()->setText(QString::fromLocal8Bit(selectedBytes()));
	}
}
